...
/*   Updated: 2023/06/29 20:41:17 by lgirault         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	Harl::set_level_filtre(std::string const& filtre)
{
	if (filtre == "DEBUG")
		return (1);
	else if (filtre == "INFO")
		return (2);
	else if (filtre == "WARNING")
		return (3);
	else if (filtre == "ERROR")
		return (4);
	return (0);
}

void	Harl::complain(std::string level, int level_filtre)
{
	int	i;
	...
	if (i < 4)
	{
		switch (level_filtre)
		{
			...
			case 4:
				...
				break;
			default:
				std::cout << "Invalid filtre" << std::endl;
				break;
		}
	}
	else
